    ...
    return (
        <div className="mental-health-page">
            <div className="mental-health-intro">
                ...
                <p>In conversation with prominent public health expert, community organizer and retired physician Marilyn Wong, a prominent public health expert community organizer and retired physician, noted that mental health was one of the main health issues affecting the community along with higher rates of liver cancers, oropharyngeal cancers, and type 2 diabetes. Among more recent immigrants, Wong noticed that many white collar professionals migrating to the United States reported feelings of worthlessness regarding their own skills. Facing language barriers and downward economic mobility, these immigrants struggled with self esteem, self-confidence, and the pressure to be breadwinners for their families. On the other hand, Wong noticed that the younger generation often felt like they were carrying the burden of success, with the hopes and sacrifices of their parents and caregivers piled onto their own aspirations.</p>
                ...
                <p>Wong remembers working as a community organizer in San Francisco in the 1970s, when she would often find herself taking the bus with community members who needed her help to translate during medical visits at San Francisco General Hospital. “If you cannot communicate, that’s a big detriment to your health,” she said, noting the difficulty for healthcare providers to figure out an appropriate diagnosis or treatment plan due to language barriers. It also made it more difficult to build rapport between patients and providers, impacting quality of care. On these bus rides, Wong said she would often hear about community members’ deep worries about their own health, and how hurried visits to the doctor’s office did not allow them to share these concerns. For example, a stomachache could trigger concerns regarding gastric cancer, but there would be no opportunity to bring this up with the doctor during the short five-minute visit.</p>
