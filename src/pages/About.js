            ...
            <div className='information'>
                <div className='overview'>
                    <div className='description'>
                        ...
                        <p>Special Thanks to: Justin Hoover, Sine Hwang Jensen, Jennie Lew, Susan Moffat, Ling-chi Wang, and Linda Wang </p>
                        <p>Further Acknowledgements to: Jeffrey Acido, Shoshana Arai, Alice Barkley, Sally Chen, Joyce Cheng, Kit Dai, Henry Der, Harvey Dong, Paul Fong, Grant Ave Follies, Estella Habal, Mui Ho, Nancy Hom, Beverly Karnatz, Jeanne Kearsley, Julia LaChica, Jeanette Lazam, Terry Ow-Wing, Vin Pan, Jon Pon, Curt Sanford, Winston Tseng, Marilyn Wong, and Lisa Wymore</p>
