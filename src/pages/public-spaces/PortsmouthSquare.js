    ...
    return (
        <div className="portsmouth-page">
            <div className="portsmouth-intro">
                ...
                <br />
                <p>The Hilton Hotel is also home to the Chinese Culture Center of San Francisco, which is located on the third floor of the building. The center is dedicated to promoting and preserving Chinese culture in the Bay Area, and it offers a variety of programs and events throughout the year, including art exhibitions, performances, and workshops.<sup>17</sup> Visitors to the city can experience the unique blend of history and culture that makes this neighborhood one of the most vibrant and exciting places to visit in the Bay Area.</p>
                <h3>Chinatown’s Living Room</h3>
                <p>Many residents in San Francisco’s Chinatown and Tenderloin neighborhoods live in single room occupancies (SROs), where they rent small, furnished bedrooms with access to shared kitchens and bathrooms.<sup>18</sup> For many, their only private spaces are their bedrooms. As such, having access to public spaces is especially important. For those living in Chinatown, Portsmouth Square often serves as their “living room” —a space to meet up with friends, eat food, and exercise.<sup>19</sup> SROs are an important part of Chinatown’s housing stock because they serve as affordable housing for new, monolingual immigrants from Asia.<sup>20</sup> With language and social barriers, it is especially difficult for immigrants to find and maintain strong social networks. Having a public space to call their own can help facilitate this important community-building.</p>
            ...
            <details className="citations">
                ...
                <ul>
                    ...
                    <li>
                        <sup>8</sup> Foster, Lee. Northern California History Weekends, 1th ed. (Globe Pequot, 2001).
                    </li>
                    <li>
