...
const PortsmouthSquare = () => {
    return (
        <div className="portsmouth-page">
            <div className="portsmouth-intro">
                ...
                <br />
                <p>As Chinese immigrants grew in number into an established community, Chinese social, religious, educational, cultural, and political institutions, as well as affordable housing and small businesses all became essential to service and maintain its growing population. Densely populated by mostly low-income immigrants and forced to be self-sustaining because of the forced isolation created by racism that prevailed at that time, open space like Portsmouth Square was essential for community health and overall well-being. Thus, maintenance and constant improvement of this key park were always vitally important to Chinatown residents, young and old alike<sup>5</sup>.</p>
                <p>The Square underwent many phases of renovations throughout the 20th century: a major city public parking garage was constructed under the park for the convenience of tourists and Chinese from outside Chinatown to visit the community, new restrooms and elevators were built; new and refurbished playgrounds, benches, and game tables provided for both active and passive uses and recreational activities; a community room infilled the area under the bridge that spanned Kearny Street (connecting the hotel to the park), and a large, flat plaza allowed for large group activities and assembly. These developments all help define the many functions of Portsmouth Square as we know it today — as both a historic park and a modern, lively gathering center for the Chinese community.</p>
                <figure>
                    <img src={require('../../assets/images/portsmouth/PortsmouthSquare_3.jpeg')} className='vertical-img'/>
                    <figcaption>
                        Portsmouth Square’s Goddess of Democracy Statue<sup>6</sup>
                    </figcaption>
                </figure>
                <br />
                ...
                <figure>
                    ...
                    <figcaption>
                        Sailing ship "U.S.S. Portsmouth"<sup>11</sup>
                    </figcaption>
                </figure>
                <br />
                <figure>
                ...
                <p>In addition to its historical and cultural significance, Portsmouth Square is also connected to the nearby Hilton Hotel (previously Holiday Inn Hotel) by a pedestrian footbridge.<sup>15</sup> This bridge allows visitors to easily access both the square and the hotel by avoiding the heavy traffic on Kearny Street,<sup>16</sup> and it has become a popular spot for taking photos and enjoying panoramic views of the city.</p>
                <figure>
                    <img src={require('../../assets/images/portsmouth/PortsmouthSquare_7.jpeg')} className='horizontal-img'/>
                    <figcaption>
                        Pedestrian Bridge Connecting Portsmouth Square to Hilton Hotel<sup>17</sup>
                    </figcaption>
                </figure>
                <br />
                <p>The Hilton Hotel is also home to the Chinese Culture Center of San Francisco, which is located on the third floor of the building. The center is dedicated to promoting and preserving Chinese culture in the Bay Area, and it offers a variety of programs and events throughout the year, including art exhibitions, performances, and workshops.<sup>18</sup> Visitors to the city can experience the unique blend of history and culture that makes this neighborhood one of the most vibrant and exciting places to visit in the Bay Area.</p>
                <h3>Chinatown’s Living Room</h3>
                <p>Many residents in San Francisco’s Chinatown and Tenderloin neighborhoods live in single room occupancies (SROs), where they rent small, furnished bedrooms with access to shared kitchens and bathrooms.<sup>19</sup> For many, their only private spaces are their bedrooms. As such, having access to public spaces is especially important. For those living in Chinatown, Portsmouth Square often serves as their “living room” —a space to meet up with friends, eat food, and exercise.<sup>20</sup> SROs are an important part of Chinatown’s housing stock because they serve as affordable housing for new, monolingual immigrants from Asia.<sup>21</sup> With language and social barriers, it is especially difficult for immigrants to find and maintain strong social networks. Having a public space to call their own can help facilitate this important community-building.</p>
                <p>At the height of the COVID-19 pandemic, anti-Asian hate crimes skyrocketed, bolstered by racist stereotypes and anti-Chinese rhetoric from political leaders. After the Atlanta Spa Shootings, Asian-American leaders across the United States rallied their communities to demand an end to race-based, gender-based violence. One of the biggest protests occurred in Portsmouth Square, where speakers reaffirmed their right to live in the United States and called for greater protections for seniors.<sup>22</sup> However, this is not the first time Portsmouth Square has served as a place of protest. On August 17th, 1968, the Concerned Chinese for Action and Change, a coalition of college students from across the Bay Area, marched down Grant Street to protest poor living conditions in Chinatown. The march ended at Portsmouth Square, where speakers condemned the activities of slumlords, sweatshop owners, and local political leaders.<sup>23</sup> </p>
                <p>Presently, Portsmouth Square is used as a community gathering space by a variety of people. For many residents in the area, social life in Chinatown is defined by the neighborhood’s many community-based organizations. These organizations use Portsmouth Square as a space to host tai chi classes, host musical performances, and circulate information about housing and other social services. The plaza is also frequented by Chinese elders, who are often gossiping and gambling with friends.<sup>24</sup> In addition, the space is used by unhoused individuals. These people often have no other place to go and call Portsmouth Square home. For the Chinatown community, Portsmouth Square is an important space for community-building, political action, and socializing.</p>
                <figure>
                    <img src={require('../../assets/images/portsmouth/PortsmouthSquare_8.jpeg')} className='horizontal-img'/>
                    <figcaption>
                        Chinese elders doing exercise in Portsmouth Square<sup>25</sup>
                    </figcaption>
                </figure>
                <br />
                ...
                <br />
                <p>Many people have asked for the pedestrian bridge connecting the Holiday Inn to Portsmouth Square to be removed because it shades the tot lot in Portsmouth. A larger elevator building to the Portsmouth Square Garage parking was also requested, but this may have an adverse effect on the upper terrace.<sup>34</sup></p>
                <p>In 1983, the Office of Community Development granted the CBPRC $90,000 to re-equip and move Portsmouth Square’s tot lot to a sunny location since its original location is shaded by the pedestrian bridge. However, the new location is exactly where the Bank of Canton shadow will fall. According to the Planning Department Environmental Review Officer Alec Bash, this technical error resulted from the  Environmental Science Associates’ miscalculation on the EIR (Environmental Impact Report) of the Bank of Canton. Bash mentions that the accurate measurements indicate there will be 15 more hours of shade than was previously reported. The error was discovered by the UC Environmental Stimulation Laboratory in a study. As a result of the embarrassment due to certifying an error document as accurate, the Planning Commission refused to penalize the Bank of Canton.<sup>35</sup></p>
                <p>In the end, a phasing plan for implementation was created in the Portsmouth Square Master Plan. In Phase I, a new elevator building and restrooms connected to the open air portal at the bridge's entrance, a game table area near the intersection of Kearny Street and Washington Street, and a multi-level play area placed to maximize sunlight and minimize wind would be constructed. In addition, a maintenance storage area would be renovated. The upper plaza level will be renovated in Phase II, with new paving, seating, and raised lawn areas. The lower plaza will be renovated in Phase III, with new paving, seating, and planting. In Phase IV, a senior citizens' recreation building beneath the bridge will be constructed to offer a recreational space during poor weather.<sup>36</sup></p>
                <p className="quote-title">Prop K - Portsmouth Square</p>
                <p className="quote">On the June 1984 ballot, San Francisco citizens passed Prop K, the Sunlight Ordinance,  in response to growing concern about the effects of buildings' shadows on the city's open spaces. The ordinance covered all properties under the Recreation and Park Commission's jurisdiction or designated for acquisition. Section 295 of the city planning code requires the planning commission to make a finding that any shadow cast by the project on property under the jurisdiction of the Recreation and Park department is insignificant before issuing a permit for a project that exceeds 40 feet in height.<sup>37</sup></p>
            ...
            <details className="citations">
                ...
                <ul>
                    ...
                    <li>
                        <sup>5</sup>Jennie Lew (former CBPRC member), in discussion with Beverly Karnatz, Kenny Li, Caroline Lu, Terry Ow-Wing, and Fiona Yim, San Francisco, CA, March 2023.
                    </li>
                    <li>
                        <sup>6</sup> Photo by Kenny Li.
                    </li>
                    <li>
                        <sup>7</sup> “San Francisco Chinantown Portsmouth Square and Vicinity Existing Conditions Report,” San Francisco Planning Department, December 2014, 15, <a href="https://sfplanning.org/sites/default/files/documents/citywide/portsmouth-square/Portsmouth_Square_Final_Report_lores.pdf#page=111">https://sfplanning.org/sites/default/files/documents/citywide/portsmouth-square/Portsmouth_Square_Final_Report_lores.pdf#page=111</a>.
                    </li>
                    <li>
                        <sup>8</sup> Mary Burk and Adah Bakalinsky, Stairway Walks in San Francisco: The Joy of Urban Exploring, (Wilderness Press, 2018), 12.
                    </li>
                    <li>
                        <sup>9</sup> Foster, Lee. Northern California History Weekends, 1th ed. (Globe Pequot, 2001).
                    </li>
                    <li>
                        <sup>10</sup> “San Francisco Chinantown Portsmouth Square and Vicinity Existing Conditions Report,” San Francisco Planning Department, December 2014, 22.
                    </li>
                    <li>
                        <sup>11</sup> L.S. Slevin, “Sailing ship "U.S.S. Portsmouth,"” San Francisco History Center, San Francisco Public Library, 1843-1915, <a href="http://sflib1.sfpl.org:82/record=b1035677">http://sflib1.sfpl.org:82/record=b1035677</a>.
                    </li>
                    <li>
                        <sup>12</sup> “THE GRAND PLAZA, SAN FRANCISCO, 1850,” Crockerart Art Museum, 1850, <a href="https://www.crockerart.org/collections/the-peter-t-pope-early-california-collection/artworks/the-grand-plaza-san-francisco">https://www.crockerart.org/collections/the-peter-t-pope-early-california-collection/artworks/the-grand-plaza-san-francisco</a>.
                    </li>
                    <li>
                        <sup>13</sup> Allen G. Pastron, and Eugene M. Hattori, eds, The Hoff Store site and gold rush merchandise from San Francisco, California, Vol. 7. (Germantown: Society for Historical Archaeology, 1990), 7.
                    </li>
                    <li>
                        <sup>14</sup> “Portsmouth Square in 1867,” San Francisco History Center, San Francisco Public Library, 1867, <a href="http://sflib1.sfpl.org:82/record=b1002203">http://sflib1.sfpl.org:82/record=b1002203</a>.
                    </li>
                    <li>
                        <sup>15</sup> Mary Burk and Adah Bakalinsky, Stairway Walks in San Francisco: The Joy of Urban Exploring, (Wilderness Press, 2018), 16.
                    </li>
                    <li>
                        <sup>16</sup> Alice Barkley (former City Attorney to the Planning Commission), in discussion with Harrington Fan, Jennie Lew, Caroline Lu, and Fiona Yim, San Francisco, CA, March 2023.
                    </li>
                    <li>
                        <sup>17</sup> Pedestrian Bridge Connecting Portsmouth Square to Hilton Hotel. March 25, 2023. Photograph by Fiona Yim.
                    </li>
                    <li>
                        <sup>18</sup> “Arts & Culture Nonprofit: Chinese Culture Center of San Francisco: California,” CCC San Francisco, n.d., <a href="https://www.cccsf.us/">https://www.cccsf.us/</a>.
                    </li>
                    <li>
                        <sup>19</sup> Katherine Kam, “Families Live Jammed into Chinatown Rooms, with No Hope of Leaving,” San Francisco Chronicle, November 30, 2015, <a href="https://www.sfchronicle.com/bayarea/article/Families-live-jammed-into-Chinatown-rooms-with-6663902.php">https://www.sfchronicle.com/bayarea/article/Families-live-jammed-into-Chinatown-rooms-with-6663902.php</a>.
                    </li>
                    <li>
                        <sup>20</sup> “Portsmouth Square Master Plan,” n.d., box 1, folder 9, AAS ARC 2023/1, Jennie Lew Papers, Ethnic Studies Library University of California, Berkeley.
                    </li>
                    <li>
                        <sup>21</sup> Ibid.
                    </li>
                    <li>
                        <sup>22</sup> Michael Williams, “S.F. Community Leaders Rally at Portsmouth Square to Denounce Anti-Asian American Violence,” San Francisco Chronicle, March 23, 2021, <a href="https://www.sfchronicle.com/local/article/S-F-officials-Asian-American-community-leaders-16044538.php">https://www.sfchronicle.com/local/article/S-F-officials-Asian-American-community-leaders-16044538.php</a>.
                    </li>
                    <li>
                        <sup>23</sup> Karen Umemoto, “‘On Strike!’ San Francisco State College Strike, 1968–69: The Role of Asian American Students,” Amerasia Journal 15, no. 1 (January 1989): 3–41, <a href="https://doi.org/10.17953/amer.15.1.7213030j5644rx25">https://doi.org/10.17953/amer.15.1.7213030j5644rx25</a>.
                    </li>
                    <li>
                        <sup>24</sup> Beverly Karnatz (former CBPRC member), in discussion with Jennie Lew, Kenny Li, Caroline Lu, Terry Ow-Wing and Fiona Yim, San Francisco, CA, March 2023.
                    </li>
                    <li>
                        <sup>25</sup> “Portsmouth Square: A Historic Hub And Community Centerpiece,” Hoodline, May 29, 2016, <a href="https://hoodline.com/2016/05/portsmouth-square-a-historic-hub-and-community-centerpiece/">https://hoodline.com/2016/05/portsmouth-square-a-historic-hub-and-community-centerpiece/</a>.
                    </li>
                    <li>
                        <sup>26</sup> “Fact Sheet: Open Space in Chinatown”, n.d., box 1, folder 4, AAS ARC 2023/1, Jennie Lew Papers, Ethnic Studies Library University of California, Berkeley.
                    </li>
                    <li>
                        <sup>27</sup> “Amendment to the City Planning Code and Zoning Map to Reduce Height Limits”, n.d., box 2, folder 2, AAS ARC 2023/1, Jennie Lew Papers, Ethnic Studies Library University of California, Berkeley.
                    </li>
                    <li>
                        <sup>28</sup> “Portsmouth Square Master Plan”, n.d., box 1, folder 9, AAS ARC 2023/1, Jennie Lew Papers, Ethnic Studies Library University of California, Berkeley.
                    </li>
                    <li>
                        <sup>29</sup> Lizzie Johnson, “Changes could be in store Portsmouth Square, SF’s oldest plaza,” SFGATE, April 28, 2017, <a href="https://www.sfgate.com/bayarea/article/Changes-could-be-in-store-Portsmouth-Square-11106856.php">https://www.sfgate.com/bayarea/article/Changes-could-be-in-store-Portsmouth-Square-11106856.php</a>.
                    </li>
                    <li>
                        <sup>30</sup> “CNIRC Survey”, n.d., box 1, folder 6, AAS ARC 2023/1, Jennie Lew Papers, Ethnic Studies Library University of California, Berkeley.
                    </li>
                    <li>
                        <sup>31</sup> Terry Ow-Wing (former CBPRC member), in discussion with Beverly Karnatz, Jennie Lew, Kenny Li, Caroline Lu, and Fiona Yim, San Francisco, CA, March 2023.
                    </li>
                    <li>
                        <sup>32</sup> “CNIRC Survey”, n.d., box 1, folder 6, AAS ARC 2023/1, Jennie Lew Papers, Ethnic Studies Library University of California, Berkeley.
                    </li>
                    <li>
...
export default PortsmouthSquare
